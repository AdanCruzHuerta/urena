...
-- -----------------------------------------------------
-- Table `rgdiazco_urena`.`roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `rgdiazco_urena`.`roles` ;

CREATE TABLE IF NOT EXISTS `rgdiazco_urena`.`roles` (
...
CREATE TABLE IF NOT EXISTS `rgdiazco_urena`.`administrador` (
  ...
  INDEX `fk_administrador_roles1_idx` (`roles_id` ASC),
  CONSTRAINT `fk_administrador_roles1`
