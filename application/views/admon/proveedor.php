<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<ol class="breadcrumb breadcrumb-arrow">
			...
			<li><a href="<?php echo site_url("admon/proveedores");?>">Provedores</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="proveedor" id="proveedor" value="<?php echo $proveedor->nombre;?>">
									</div>
								</div>
								<div class="form-group">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="responsable" id="responsable" value="<?php echo $proveedor->responsable;?>">
									</div>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<input type="hidden" name="id" id="id" value="<?php echo $proveedor->id;?>">
...
<script>
	$(document).ready(function(){
		$('#estado option[value="<?php echo $proveedor->estado;?>"]').attr("selected",true);
		...
		$.ajax({
			...
			success: function(result){
				...
				$('#municipio option[value="<?php echo $proveedor->municipio;?>"]').attr("selected",true);
			}
		});
		...
		var validacion = $('#form-proveedor').validate({
			...
			submitHandler: function() {
				$.post("<?php echo site_url('admon/actualiza_proveedor')?>", $('form#form-proveedor').serialize(), function(result){
